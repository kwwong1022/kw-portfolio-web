walkerBackgroundSketch = (s) => {
    ...
    s.setup = function() {
        s.createCanvas(document.querySelector('#'+backgroundSketchId).clientWidth, document.querySelector('#'+backgroundSketchId).clientHeight-25);
    ...
    s.windowResized = function() {
        s.resizeCanvas(document.querySelector('#'+backgroundSketchId).clientWidth, document.querySelector('#'+backgroundSketchId).clientHeight);
    }

}

let backgroundSketchId = 'walker-background-sketch';
var walkerBackgroundP5 = new p5(walkerBackgroundSketch, backgroundSketchId);